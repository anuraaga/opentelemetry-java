...
public interface SpanData {
   ...
   * was greater than the configured maximum value. See: {@link SpanLimits#getLinkCountLimit()}
   *
   ...
   * greater than the configured maximum value. See: {@link SpanLimits#getSpanAttributeCountLimit()}
   *
